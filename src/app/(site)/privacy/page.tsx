...
export const metadata = pageMetadata({
  ...
  description:
    "How information submitted through the 'Book a Conversation' form on this site is collected, used and retained.",
  path: "/privacy",
});
    ...
    <main className="band-white">
      <div className={`container-prose ${styles.prose}`}>
        ...
        <p className={styles.body}>
          This notice covers the &quot;Book a Conversation&quot; form on this site. It does not
          cover the Safety Margin check, which has its own privacy policy, linked below.
        </p>

        <h2 className={styles.itemHeading}>Who collects it</h2>
        <p className={styles.body}>
        ...
        <h2 className={styles.itemHeading}>What is collected</h2>
        <p className={styles.body}>
        ...
        <h2 className={styles.itemHeading}>Purpose</h2>
        <p className={styles.body}>
        ...
        <h2 className={styles.itemHeading}>Consent</h2>
        <p className={styles.body}>
        ...
        <h2 className={styles.itemHeading}>Retention</h2>
        <p className={styles.body}>
        ...
        <h2 className={styles.itemHeading}>Third-party processors</h2>
        <p className={styles.body}>
        ...
        <h2 className={styles.itemHeading}>Cookies &amp; analytics</h2>
        <p className={styles.body}>
          This site does not use cookies, analytics or cross-site tracking of any kind.
        </p>

        <h2 className={styles.itemHeading}>Cross-border processing</h2>
        <p className={styles.body}>
        ...
        <h2 className={styles.itemHeading}>Your rights</h2>
        <p className={styles.body}>
